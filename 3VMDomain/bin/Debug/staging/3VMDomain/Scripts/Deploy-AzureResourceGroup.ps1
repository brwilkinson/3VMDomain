...
Param(
    ...
    [string] $ResourceGroupName = 'AzureResourceGroup3-5',
...
if ($UploadArtifacts) {
    ...
    $StorageAccountKey = (Get-AzureRmStorageAccountKey -ResourceGroupName $StorageAccountResourceGroupName -Name $StorageAccountName)[0].Key1
